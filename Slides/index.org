...
#+CAPTION:Scores des deux premières composantes principales calculées sur des données de SNPs d'invidus humains de populations européenne, africaine et afro-américaine (données 1000Genome \cite{1000Genome_2015}).
...
où 
- $\matr{W}$ est la matrice latente tel que 
...
On calcule les valeurs singulières pour visualiser la variance expliqué par
