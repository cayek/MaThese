...
\newcommand{\dploide}{$d\text{-ploïde}$ } %% dploide
...
\newcommand{\Dlambda}{\matr{D}_{\lambRidge}} %% matrice utilisé dans l'estimateur ridge
...
\newcommand{\D}{\matr{D}} %% matrice utilisé dans l'estimateur ridge