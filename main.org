...
trouver un seuil les contrôle et de filtrer sur les controle ([[https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5007749/][Automated quality
control for genome wide association studies]]).
...
#+begin_src shell
  ...
  plink --bfile Simons --maf 0.05 --mind 0.05 --geno 0.05 --hwe  --snps-only --autosome --make-bed --out Simons_CQ --threads 16
#+end_src
***** TODO Prunning
:LOGBOOK:
