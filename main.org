...
marqueurs moléculaires examinés dans les génomes ou dans cellules, plusieurs
...
différents individus (Balding 2006). Les GWAS ont été étendus à des études
...
phénotypes (Rakyan et al., 2011). Des approches similaires ont été appliquées à
la caractérisation de la variation transcriptionnelle par rapport à différents
environnements, traitements, phénotypes ou maladies (Slonim, 2002). D'autres
exemples d'études d'association incluent des études d'association
génétique-environnement (GEAS) dans lesquelles les loci génétiques sont testés
pour leur corrélation avec des gradients écologiques afin de détecter les
signatures de sélection naturelle (Savolainen et al., 2012). Dans un court laps
de temps, les études d'association ont permis des progrès considérables dans
l'identification des variantes de gènes qui confèrent une susceptibilité aux
