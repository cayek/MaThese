...
les facteurs de confusion qui augment le nombre de fausses découvertes dans les
test d'association. Dans chaque chapitre nos méthodes sont comparées aux
méthodes existante et appliquées à des jeux de données réelles de la biologie pour
illustrer leurs utilité.
