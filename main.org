...
***** TODO Comparaison numérique sur des simulations
:LOGBOOK:
...
#+begin_src R :results output :exports both
  ...
  ## samplers
  samplers <- ExpRsampler_trueData(Y = "./Data/ThesisDataset/3Article/1000GenomesPhase3/1000GenomesPhase3_QC_norel_prunned_scaled_noNA.rds",
                                   X = "./Data/ThesisDataset/3Article/1000GenomesPhase3/X_EAS.rds",
                                   outlier = NULL) * param()
  dat <- samplers[[1]] %>% ExpRmouline()

  ## methods
  methods <- method_CV_ridgeLFMM(n.fold.col = 5, n.fold.row = 2,
                                 lambdas = c(1e-)) * param()
#+end_src
