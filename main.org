...
$\lamba$ le paramètre de régularisation. 

Nous remarquons dans un premier temps que la fonction eqref:eq:optim_ridge_reg
est convexe en les variables 
$$ 
\W = \U \V^{T}, \B. 
$$
Parler de convexité et strict convexité ???
