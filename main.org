...
de fréquences de génotypes dans les $K$ clusters génétiques $\G$, de taille $p
...
citep:Bertsekas_1997. Le problème d'optimisation selon $\G$, quand $\Q$ est fixé,
...
estimations spatiales des matrices $\Q$ et $\G$ citep:Martins_2016; et nous avons
