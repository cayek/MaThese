...
*** TODO Fusion de tous les chromosomes
:LOGBOOK:
...
#+begin_src shell :session *ssh krakenator* :result output
  ...
  ## snp to remove
  echo "rs6658405\n.\nrs145926341\nrs141927528" > excluded_variant.txt

  for file in ALL.chr[0-9]*.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.bed
  do
      echo "===== $file ====="
      plink --bfile $file --exclude excluded_variant.txt --make_bed --out `basename $file .vcf.gz`_excluded
  done
#+end_src
...
:header-args: :cache no :eval no-export :results output :exports none
:END:
*** STARTED Comparaisons des méthodes                            :noexport:
:LOGBOOK:
...
\begin{figure}[!t]
\centering
\includegraphics[width=14cm, height=20cm]{./OUTPUT/Rplots/method_comp.pdf.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=14cm, height=10cm]{./OUTPUT/Rplots/gwas_venn.pdf.png}
\includegraphics[width=14cm, height=10cm]{./OUTPUT/Rplots/gwas_qqplot.pdf.png}
...
#+begin_src R 
  ...
  save_plot_MaTheseR(pl, "ewas_screeplot.pdf.png", height = 7, width = 14)
  ...
  pl <- ggplot(toplot, aes(x = K, y = err.mean, color = lambda)) +
    ...
    MaTheseR.params$gtheme
  pl
  save_plot_MaTheseR(pl, "ewas_CV_K.pdf.png", height = 7, width = 14)
  ...
  pl <- ggplot(toplot, aes(x = log(lambda), y = err.mean, color = K)) +
    ...
    MaTheseR.params$gtheme
  pl
  save_plot_MaTheseR(pl, "ewas_CV_lambda.pdf.png", height = 7, width = 14)
#+end_src

#+BEGIN_EXPORT latex
\begin{figure}[!t]
\centering
\includegraphics[width=14cm, height=7cm]{./OUTPUT/Rplots/ewas_screeplot.pdf.png}
\includegraphics[width=14cm, height=7cm]{./OUTPUT/Rplots/ewas_CV_K.pdf.png}
\includegraphics[width=14cm, height=7cm]{./OUTPUT/Rplots/ewas_CV_lambda.pdf.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=14cm, height=10cm]{./OUTPUT/Rplots/ewas_venn.pdf.png}
\includegraphics[width=14cm, height=10cm]{./OUTPUT/Rplots/ewas_qqplot.pdf.png}
