...
Les travaux de cette thèse ont été financé par le LabEx PERSYVAL-Lab et est
co-encadrée par Olivier François du laboratoire TIMC-IMAG et Olivier Michel du
laboratoire GIPSA-lab. Les travaux on principalement été réalisé au sein de
l'équipe BCM. L'équipe BCM du laboratoir TIMC-IMAG est spacialisé en ...

parler de leur logiciel nanananan qui devellope des logiciel sur la génomic etc

En effet, les données évoluant, il est nécéssaire de faire évoluer les logiciels
d'annalyse. Ainsi, les logiciels développé dans cette thèse sont la suite
logique de logiciels dévelopés dans l'équipe BCM : =TESS= 2.3
citep:Durand_2009 et =LEA= citep:Frichot_2015. 
...
rependant à des problèmes spécifique de la biologie. Ces logiciels répondent à
...
méthodologiques et logicielles, afin d'ajouter des fonctionnalités à nos
packages en fonction des retours des utilisateurs. D'autre part, nos algorithmes
reposent sur des techniques de factorisation matricielle. Ainsi, nos travaux
ouvrent des perspectives sur l'utilisation de la factorisation matricielle à
d'autres problèmes d'analyse de données.
...
*Titre :* Méthodes de factorisation matricielle pour la génomique des
populations et les tests d'association.

*Résumé :* Nous présentons des nouvelles méthodes reposant 

pour étudier l'ascendance à
partir de données 

*Mots-clés :* optimisation, factorisation de matrices, structure génétique des
populations, métissage, test d'association, facteurs de confusion, bio-informatique.

*Title:* Matrix factorization methods for population genomics and association
mapping.

*Summary:* 

*Keyword:* optimization, matrix factorization, genetic structure of populations,
