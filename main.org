...
******* STARTED Calcul du gradient climatique
:LOGBOOK:
...
***** STARTED Scree plot du 1000 genome
:LOGBOOK:
...
#+begin_src R :results output :exports both
  ...
  Y <- "./Data/ThesisDataset/3Article/1000GenomesPhase3/1000GenomesPhase3_QC_norel_prunned_scaled_noNA.rds"
