...
#+ATTR_LATEX: :align lp{3cm}lp{3cm} p{4cm} :float sideways
...
#+begin_src R 
  ...
  saveRDS(indiv.df, "./Data/ThesisDataset/Simons/indiv.df")
...
#+begin_src R 
  ...
  saveRDS(G.scaled, "./Data/ThesisDataset/Simons/G_pruned_scaled_binom.rds")
#+end_src
...
#+NAME: code:Simons_pca_plot
#+CAPTION: Dépend de [[code:Simons_pca]]
#+begin_src R 
  library(MaTheseR)
