...
#+CAPTION: *Méthodes reposant sur l'équation ref:eq:model0 pour la correction des facteurs de confusion dans les études d'association.* Les méthodes ridgeLFMM et LassoLFMM sont présenté dans cette thèse. Les méthodes cate, sva-twostep et sva-riw sont plus détaillées dans la section [[sec:similar_method]].
