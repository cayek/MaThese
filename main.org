...
méthodologique et logicielle, afin d'ajouter des fonctionnalités à nos packages
en fonction des retours des utilisateurs. D'autre part, nos algorithmes reposent
sur des techniques de factorisation matricielle. Ainsi, nos travaux ouvrent des
perspectives sur l'utilisation de la factorisation matricielle à d'autres
