...
#+begin_src shell
  cd /home/cayek/Projects/Thesis/MaThese/Data/Simons
  plink --vcf vcfs.variants.public_samples.279samples.tar
#+end_src
** Résultats
:PROPERTIES:
:header-args: :cache no :eval no-export :results output :exports none :session *krakR* :dir /scp:cayek@krakenator:~/Projects/Thesis/MaThese/
...
- LYN : [[https://fr.wikipedia.org/wiki/LYN_(prot%25C3%25A9ine)][wikipedia de la protéine]], [[http://www.ensembl.org/Homo_sapiens/Gene/Summary?g=ENSG00000254087;r=8:55879813-56014168][ENSG00000254087]], 
...
candidats du GWAS catalog sur le chromosome 6 ont un rang plus faible avec les
\pvalues renvoyées par PCAlm et ridgeLFMM (Figure ref:fig:gwas_qqplot_top B).
Sur les autres chromosomes ce sont les méthodes lassoLFMM et cate qui retrouve
le plus vite les candidats du GWAS catalog (Figure ref:fig:gwas_qqplot_top B).
...
#+begin_src R 
  ...
  table.df %>% head(20) %>% dplyr:::select(Snp, `Gènes dans la zone`) %>% knitr::kable()
...
|Snp                 |Gènes dans la zone                                          |
|:-------------------|:-----------------------------------------------------------|
|\textbf{rs1464510}  |\textbf{LPP}                                                |
|\textbf{rs17810546} |\textbf{IQCJ-SCHIP1, IL12A-AS1, IL12A}                      |
|\textbf{rs13151961} |\textbf{KIAA1109, ADAD1}                                    |
|\textbf{rs653178}   |\textbf{CUX2, LINC02356, SH2B3, ATXN2}                      |
|\textbf{rs917997}   |\textbf{IL1RL1, IL18R1, IL18RAP, MIR4772, SLC9A4, SLC9A2}   |
|rs6840978           |IL21-AS1                                                    |
|rs9811792           |IL12A-AS1                                                   |
|\textbf{rs13098911} |\textbf{FYCO1, FLT1P1, CCR3}                                |
|\textbf{rs2816316}  |\textbf{}                                                   |
|\textbf{rs6441961}  |\textbf{CCR3, UQCRC2P1}                                     |
|\textbf{rs4675374}  |\textbf{CD28, ICOS}                                         |
|rs1018326           |UBE2E3, LINC01934                                           |
|rs7648827           |LRRC2                                                       |
|\textbf{rs13003464} |\textbf{LINC01185, REL, PUS10, RNA5SP95, KIAA1841, C2orf74} |
|\textbf{rs1250552}  |\textbf{ZMIZ1}                                              |
|rs7629708           |LPP                                                         |
|\textbf{rs2298428}  |\textbf{HIC2, UBE2L3, YDJC, CCDC116}                        |
|rs1394466           |DCC                                                         |
|\textbf{rs1893217}  |\textbf{PTPN2}                                              |
|\textbf{rs864537}   |\textbf{POU2F1, CD247}                                      |
Expr save in ./OUTPUT/Expr/gwas_table_toprint.rds
#+end_example
