...
présent dans au moins $5\%$ des observations. 
...
Enfin nous avons utilisé beagle pour imputer la matrice pour les données manquantes
...
******* DONE Scale, remove missing data and export to =matter=
CLOSED: [2017-08-16 mer. 15:29]
:LOGBOOK:
- State "DONE"       from "RUNNING"    [2017-08-16 mer. 15:29]
...
***** STARTED Validation croisée du modèle lfmmRidge
:LOGBOOK:
