...
#+SETUPFILE: ~/Downloads/org-html-themes-master/setup/theme-readtheorg.setup
...
#+BEGIN_EXPORT html
<script src="/MathJax/MathJax.js?config=TeX-AMS_HTML,notations.js"></script>
#+END_EXPORT
...
#+begin_src R :session *R* :dir ~/Projects/Thesis/MaThese
  ...
  ## toplot <- cbind(toplot, ggmap::geocode(toplot$citie)) ## do not work sometime...
  toplot <- toplot %>%
    mutate(lon = c(-1.174320, 8.675277, 37.906193, -74.005973, 12.567380),
           lat = c(52.355518, 9.081999, 0.023559, 40.712775, 41.871940),
           r = 8)
  ...
  save_expr(toplot, "tess3_intro_freq_toplot_df.rds")
...
#+begin_src R :session *R* :dir ~/Projects/Thesis/MaThese
  ...
  save_expr(mappl, "tess3_at_map.rds")
...
#+NAME: code:geas:map
#+CAPTION: Dépend de [[code:eas_climatic_gradient_plot]]
#+begin_src R :session *R* :dir ~/Projects/Thesis/MaThese/ :results silent
  library(MaTheseR)
  MaTheseR.params <- get_MaTheseRparams()
...
#+begin_src R :results output latex :exports results :session *R* :dir ~/Projects/Thesis/MaThese/
  ...
  table.df %>%
    ...
    caption = "{\\bf 20 premiers groupes de SNPs associés avec la maladie \\coeliac retournés par l'algorithme lassoLFMM.} Les lignes en gras sont les SNPs référencés dans la base de données GWAS catalog.") %>%
    print(include.rownames=FALSE,
