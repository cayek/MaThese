...
#+begin_src R 
  ...
  methods <- list()
  methods$m.lasso <- method_lassoLFMM(K = K.method, nozero.prop = nozero.prop,
                                      lambda.K = 100, lambda.eps = 0.001, lambda = 10e-2,
                                      relative.err.epsilon = 1e-6,
                                      col.mask = col.mask,
...
#+begin_example
  ...
  It = 2/100, err2 = 0.903653256741087
  It = 3/100, err2 = 0.903571723701793
  It = 4/100, err2 = 0.903542788594417
  It = 5/100, err2 = 0.903541852013131
  It = 6/100, err2 = 0.903546623150277
  It = 7/100, err2 = 0.903549675465802
  It = 8/100, err2 = 0.903551453958885
  It = 9/100, err2 = 0.903552407374758
  === lambda = 0.1, no zero B proportion = 0.0124769319880922
  Saving intermediate res into./OUTPUT/Expr/eas_inter_lassoLFMM.rds
  unmask data
  running hp
       pvalue     colname index outlier   score rep.sampler rep.method    method
  1 0.6467073 rs575272151     1   FALSE 0.45844           1          1 lassoLFMM
    method.K method.lambda
  1        5           0.1
...
#+CAPTION: Dépend de [[code:eas_expr]] [[code:eas_expr]]
#+begin_src R 
  library(MaTheseR)
  library(MatrixFactorizationR)
  library(matter)
...
#+begin_src R 
  ...
  save_expr(aux.df, "eas_all_qvalue_df.rds")
#+end_src
