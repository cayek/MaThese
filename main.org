...
\caption{A) Diagramme de Venn de la liste de candidats controlé à un taux de
...
: [1] lm           PCAlm        sva-two-step sva-irw      lassoLFMM   
: [6] cate         ridgeLFMM   
: Levels: lm PCAlm sva-two-step sva-irw lassoLFMM cate ridgeLFMM oracle
: [[./OUTPUT/Rplots/ewas_top_power_article.png]]
#+begin_example
# A tibble: 8 x 2
        method power
         <chr> <dbl>
