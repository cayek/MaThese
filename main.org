...
:header-args: :cache no :eval no-export :results output :exports none
:END:
*** DEBUG Comparaisons des méthodes
:LOGBOOK:
...
#+begin_src R
  ...
  ## gif
  gif.prop <- plot_gif(toplot.prop, "proportion of H1", test = TRUE)
  save_expr(gif.prop, filename = "gif.prop.rds")

  ## auc
  auc.prop <- plot_AUC(toplot.prop, "proportion of H1", test = TRUE)
  save_expr(auc.prop, filename = "auc.prop.rds")
  ...
  ## gif
  gif.rho <- plot_gif(toplot.rho, "rho", test = TRUE)
  save_expr(auc.prop, filename = "gif.rho.rds")

  ## auc
  auc.rho <- plot_AUC(toplot.rho, "rho", test = TRUE)
  save_expr(auc.prop, filename = "auc.rho.rds")
#+end_src
...
#+begin_src R 
  ...
  gif.prop <- readRDS("./OUTPUT/Expr/gif.prop.rds")
  gif.rho <- readRDS("./OUTPUT/Expr/gif.rho.rds")
  auc.prop <- readRDS("./OUTPUT/Expr/auc.prop.rds")
  auc.rho <- readRDS("./OUTPUT/Expr/auc.rho.rds")
...
#+BEGIN_SRC R
  ...
  save_plot_MaTheseR(out, "ewas_results_venn.png")
#+END_SRC

#+CAPTION: Diagramme de Venn pour l'ewas
#+NAME: fig:ewas_results_venn
...
#+BEGIN_SRC R
  ...
  save_plot_MaTheseR(pll, "ewas_results_qqplot.png")
#+END_SRC

#+CAPTION: Plot quantiles-quantiles
#+NAME: fig:ewas_results_qqplot
#+ATTR_LATEX: :placement [H]
[[./OUTPUT/Rplots/ewas_results_qqplot.png]]
