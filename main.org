...
**** On filtre les individus trop apparenté
...
#+begin_src R :results output :exports both
  ...
  anyNA(G.noNa)
  G.scale <- scale(G.noNa)
  saveRDS(G.scale, "./Data/ThesisDataset/3Article/1000GenomesPhase3/1000GenomesPhase3_QC_norel_prunned_scaled.rds")
#+end_src
...
#+CAPTION: Le sampler pour les comparaisons d'experience. Dépend de [[code:1000g_G_valNum]]
#+begin_src R 
  library(MaTheseR)
  ### The sampler
