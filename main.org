...
- Note taken on [2017-06-07 Mer 14:42] \\
  ...
  - eas: ...
:END:
La génétique des population est l'étude de la distribution et des changement de
...
Une étape très imporante en génétique des populations et particulier quand on
étudie des données de SNPs est d'inférer la structure de population à partir des
données de SNPs. C'est à dire de trouver comment les individus observés
s'organise en sous populations. Dans cette thèse nous proposons une méthode
permettant l'inférence de la structure de population à partir de données de SNPs
en utilisant en plus une information géographique des individus permettant de
renforcer l'inférence de la structure de population.
