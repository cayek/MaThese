...
graphe de différenciation avec les forces évolutives
*** Visualisation de la structure génétique des populations avec l'ACP
graphe ACP
*** Les coefficient de métissage
plot sans m migrants
et formule
*** Estimation des coefficients de métissage
tableau
*** Visualisation des coefficients de métissage
barplot
*** Données géographiques
une carte (d'arabidopsis)
*** Estimation des coefficients de métissage à l'aide de données géographique
tableau et avec nos méthodes.
*** Les matrices d'ascendance génétique
formule factorisation matrice
*** Information géographique
carte d'un graphe avec la formule de math
...
*** Application à des données /Arabidopsis Thaliana/
présentation du data set avec une petite fleur et la carte.
on va l'analyser avec tess3r (comme ca je parle du package ici)
...
la covariable : les conditions climatique
...
**** Rna-seq et DNA methylation, c'est quoi ?
