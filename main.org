...
:END:
Les individus d'une même population ce reproduise entre eux, ce transmettant
ainsi leurs patrimoines génétiques. Quand on observe des les génomes d'individus
provenant de plusieurs population différentes, on remarque des différences dans
...
génétiques des population s'uppose que les individus que l'on observe sont le
produit de la reproduction sexué entre des individus provenant de plusieurs
population que l'on appel ancestral. Connessant les fréquence d'allèle dans les
populations ancestrales il est possible de messurer pour chaque individu la
...
**** Scripts
***** Africain Européen et Afro américain 
