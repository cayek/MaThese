...
**** RUNNING Mesure de comparaison des performances
:LOGBOOK:
- Note taken on [2017-08-06 Sun 09:52] \\
  Ca tourne avec la sauvegard sur disk :D
  tail -f ValNum.y2017_m08_d06.log
- State "RUNNING"    from              [2017-08-06 Sun 09:52]
:END:
...
*** Étude d'association entre des niveau de méthylalation de l'ADN et la polyarthrite rhumatoïde (EWAS)
La polyarthrite rhumatoïde est une maladie autoimune. Dans cette étude nous
souhaitons étudier le rôle de la méthylation de l'ADN dans le développement de
la polyarthrite rhumatoide. La méthylation de l'ADN est un processus au cour du
quelle un groupe methylé est ajouté au molécule d'ADN. La méthylation peut
changer l'activité de l'ADN et en particulier modifier sa transcription en
protéine. Pour cette étude nous avons accès au niveau de méthylation de $485577$
site de l'ADN pour 354 individus attaind de polyarthrite rhumatoide et 335
individus sains. Il est connu que pour la méthylataion de l'ADN dépend de l'age,
du sexe et de la consomation de tabac des individus. Nous savons aussi que le
type de la cellule ayant servi pour les mesures ainsi que les variation ajouté
pendants les différente mesure (appelé batch effect dans la litérature)
influence le niveau de éthylation. Ces différents facteurs peuvent être des
facteurs de confusion, ils ont d'ailleurs été pris en compte dans les études
d'association ont été faites à partir des données que nous allons étudier
cite:Rahmani_2016,Zou_2014,Liu_2013.
