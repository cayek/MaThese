...
#+begin_src R
  ...
  #################
  ## by prop outlier
  toplot.h1 <- expr$df.res %>%
    dplyr::filter(pvalue.index == "pvalue1") %>%
    dplyr::mutate(x = prop.outlier)

  ## C
  h1.gif <- plot_gif(toplot.h1, "proportion of H1", test = TRUE)
  mylegend <- g_legend(h1.gif$pl)
  h1.gif.pl <- h1.gif.pl +
      theme(legend.position = "none")

  ## A
  h1.auc.pl <- plot_AUC(toplot.h1, "proportion of H1") +
    theme(legend.position = "none")
  ...
  ## D
  rho.gif.pl <- plot_gif(toplot.rho, "rho") + 
      theme(legend.position = "none")

  ## B
  rho.auc.pl <- plot_AUC(toplot.rho, "rho") +
      theme(legend.position = "none")
  ...
  save_plot_svd(pl, filename = "method_comp.svd")
#+end_src
